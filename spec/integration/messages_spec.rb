...
describe 'Messages protocol' do
  ...
  it 'sends and parses version correctly' do
    ...
    expect(parsed_version.protocol_version).to eql 7001
    expect(parsed_version.services).to eql 1
    ...
    expect(parsed_version.user_agent).to eql("/bitcoin_node:#{BitcoinNode::VERSION}/")
